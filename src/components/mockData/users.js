...
export const sangatVistingGurpurab = [
    ...
    { field: "user_age", headerName: "Age", sortable: true, filter: true, cellRenderer: (data) => calculateAge(data)},
...
export const taxiReport = [
    ...
    { field: "user_age", width: 75, headerName: "Age", sortable: true, filter: true, cellRenderer: (data) => calculateAge(data)},
